...
- Firebase (Hosting, Storage) - Firebase는 배포 과정을 간소화하고 팀원 모두가 쉽게 배포할 수 있는 환경을 제공함으로써, 협업을 효율적으로 진행하기 위해 선택했습니다.
</details>
...
- 원인
  - SameSite 속성 누락
- 해결 - SameSite 속성 추가 - SameSite=None 사용 시, Secure 플래그 설정 필요 - HttpOnly 속성 유지
</details>
...
- 해결 - accessToken을 갱신할 때마다 interceptor를 새로 호출
</details>
